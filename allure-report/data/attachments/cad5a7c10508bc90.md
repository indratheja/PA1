          ...
          - generic [ref=e64]:
            ...
            - generic [ref=e67]:
              - generic [ref=e68]:
                ...
                - textbox "Enter Phone" [ref=e74]: "9916910404"
              - generic [ref=e75]:
              ...
              - generic [ref=e86]:
                ...
                - generic [ref=e91]:
                  - checkbox "Monday" [checked] [ref=e92]
        ...
        - generic [ref=e201]:
          ...
          - generic [ref=e203]:
            - table [ref=e204]:
              ...
              - rowgroup [ref=e212]:
                - row "Chrome 9.0 Mbps 41.8 MB 0.61 MB/s 8.6%" [ref=e213]:
                  - cell "Chrome" [ref=e214]
                  - cell "9.0 Mbps" [ref=e215]
                  - cell "41.8 MB" [ref=e216]
                  - cell "0.61 MB/s" [ref=e217]
                  - cell "8.6%" [ref=e218]
                - row "System 0.1 Mbps 89.4 MB 0.40 MB/s 4.2%" [ref=e219]:
                  - cell "System" [ref=e220]
                  - cell "0.1 Mbps" [ref=e221]
                  - cell "89.4 MB" [ref=e222]
                  - cell "0.40 MB/s" [ref=e223]
                  - cell "4.2%" [ref=e224]
                - row "Internet Explorer 8.4 Mbps 88.6 MB 0.54 MB/s 9.5%" [ref=e225]:
                  - cell "Internet Explorer" [ref=e226]
                  - cell "8.4 Mbps" [ref=e227]
                  - cell "88.6 MB" [ref=e228]
                  - cell "0.54 MB/s" [ref=e229]
                  - cell "9.5%" [ref=e230]
                - row "Firefox 7.7 Mbps 56.9 MB 0.48 MB/s 6.6%" [ref=e231]:
                  - cell "Firefox" [ref=e232]
                  - cell "7.7 Mbps" [ref=e233]
                  - cell "56.9 MB" [ref=e234]
                  - cell "0.48 MB/s" [ref=e235]
                  - cell "6.6%" [ref=e236]
            - generic [ref=e237]:
              - paragraph [ref=e238]:
              ...
              - paragraph [ref=e240]:
                ...
                - strong [ref=e241]: 56.9 MB
              - paragraph [ref=e242]:
                - text: "Network speed of Chrome process:"
                - strong [ref=e243]: 9.0 Mbps
              - paragraph [ref=e244]:
      ...
      - complementary [ref=e299]:
        - generic [ref=e300]:
          ...
          - generic [ref=e315]:
            ...
            - button "STOP" [ref=e318] [cursor=pointer]
          - generic [ref=e319]:
...
```ts
  ...
  2  | 
  3  | test('SS1', async ({ browser }) => {
  4  | 
  5  |     const context = await browser.newContext();
  6  |     const page = await context.newPage();
  7  |     await page.goto("https://testautomationpractice.blogspot.com/");
  8  |     await page.getByRole('checkbox', { name: 'Sunday' }).check();
  9  |     await page.screenshot({ path: 'Screenshots/indra.png' });
  10 |     const mondayCheckbox = page.getByRole('checkbox', { name: 'Monday' });
  11 |     await mondayCheckbox.check();
  12 |     await mondayCheckbox.screenshot({ path: 'Screenshots/checkbox.jpeg' });
  13 |     await page.getByRole('radio', { name: 'Male', exact: true }).click();
  14 |     console.log(await page.getByText('Home').first().textContent());
  15 |     await page.getByPlaceholder('Enter Phone').fill('9916910404');
  16 |     const dynamicBtn = page.locator("//button[@onclick='toggleButton(this)']");
  17 |     await dynamicBtn.click();
  18 |     console.log(await dynamicBtn.textContent());
  19 |     await expect(dynamicBtn).toHaveText("STOP");
  20 |     await page.pause();
  21 |     await page.locator('#alertBtn').click();
  22 |     page.on("dialog", dialog => dialog.accept());
  23 |     await page.locator("#confirmBtn").click();
  24 |     page.on("dialog", dialog => dialog.accept());
  25 |     const newwindow = page.getByRole('button', { name: 'New Tab' });
  26 | 
> 27 |     const [newpage] = Promise.all([
     |                       ^ TypeError: object is not iterable (cannot read property Symbol(Symbol.iterator))
  28 |         context.waitForEvent(page),
  29 |         newwindow.click(),
  30 | 
  31 |     ])
  32 |     await newPage.getByRole('link', { name: 'TypeScript for Playwright/Cypress' }).click();
  33 | 
  34 | 
  35 | 
  36 | 
