...
- Name: alllocators.spec.js >> TC14: Verify Laptops link is visible and clickable
- Location: tests\alllocators.spec.js:105:5
...
Locator: getByRole('link', { name: 'Laptops' })
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: 'Laptops' })
...
- table:
  - rowgroup:
    - row "Name Disk (MB/s) Network (Mbps) Memory (MB) CPU (%)":
      ...
      - columnheader "CPU (%)"
  - rowgroup:
    - row "Internet Explorer 0.76 MB/s 3.0 Mbps 33.2 MB 3.6%":
      - cell "Internet Explorer"
      - cell "0.76 MB/s"
      - cell "3.0 Mbps"
      - cell "33.2 MB"
      - cell "3.6%"
    - row "Firefox 0.66 MB/s 1.5 Mbps 58.3 MB 7.3%":
      - cell "Firefox"
      - cell "0.66 MB/s"
      - cell "1.5 Mbps"
      - cell "58.3 MB"
      - cell "7.3%"
    - row "Chrome 0.29 MB/s 6.9 Mbps 36.1 MB 9.3%":
      - cell "Chrome"
      - cell "0.29 MB/s"
      - cell "6.9 Mbps"
      - cell "36.1 MB"
      - cell "9.3%"
    - row "System 0.43 MB/s 10.0 Mbps 73.7 MB 6.2%":
      - cell "System"
      - cell "0.43 MB/s"
      - cell "10.0 Mbps"
      - cell "73.7 MB"
...
> 107 |     await expect(laptopsLink).toBeVisible();
      |                               ^ Error: expect(locator).toBeVisible() failed
  108 |     await laptopsLink.click();
  109 | });
```