...
- Name: alllocators.spec.js >> TC4: Verify Male radio button can be selected
- Location: tests\alllocators.spec.js:27:5
...
- table:
  ...
  - rowgroup:
    - row "Firefox 1.1 Mbps 0.92 MB/s 4.3% 74.1 MB":
      - cell "Firefox"
      - cell "1.1 Mbps"
      - cell "0.92 MB/s"
      - cell "4.3%"
      - cell "74.1 MB"
    - row "Internet Explorer 4.7 Mbps 0.67 MB/s 8.5% 94.4 MB":
      - cell "Internet Explorer"
      - cell "4.7 Mbps"
      - cell "0.67 MB/s"
      - cell "8.5%"
      - cell "94.4 MB"
    - row "System 3.9 Mbps 0.44 MB/s 4.5% 70.0 MB":
      - cell "System"
      - cell "3.9 Mbps"
      - cell "0.44 MB/s"
      - cell "4.5%"
      - cell "70.0 MB"
    - row "Chrome 7.8 Mbps 0.84 MB/s 8.3% 74.2 MB":
      - cell "Chrome"
      - cell "7.8 Mbps"
      - cell "0.84 MB/s"
      - cell "8.3%"
