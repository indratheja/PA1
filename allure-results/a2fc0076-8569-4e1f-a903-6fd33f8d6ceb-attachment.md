...
- Name: blazedemo-booking.spec.js >> BlazeDemo flight booking matrix >> book flight from Paris to New York
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e8]:
    ...
    - table [ref=e10]:
      ...
      - rowgroup [ref=e15]:
        - row "Id 1785393811423" [ref=e16]:
          - cell "Id" [ref=e17]
          - cell "1785393811423" [ref=e18]
        ...
        - row "Auth Code 888888" [ref=e31]:
          ...
          - cell "888888" [ref=e33]
        - row "Date Thu, 30 Jul 2026 06:43:31 +0000" [ref=e34]:
          - cell "Date" [ref=e35]
          - cell "Thu, 30 Jul 2026 06:43:31 +0000" [ref=e36]
    - generic [ref=e37]: "{ \"id\": \"1785393811423\", \"status\": \"PendingCapture\", \"amount\": \"555\", \"currency\": \"USD\", \"authCode\": \"888888\", \"payment\": { \"cardNumber\": \"xxxxxxxxxxxx1111\", \"cardExpirationMonth\": \"11\", \"cardExpirationYear\": \"2018\" }, \"_links\": { \"self\": { \"href\": \"https=>\\/\\/sandbox.api.visa.com\\/cybersource\\/payments\\/v1\\/authorizations\\/1785393811423\", \"method\": \"GET\" }, \"capture\": [ { \"href\": \"https=>\\/\\/sandbox.api.visa.com\\/cybersource\\/payments\\/v1\\/authorizations\\/1785393811423\\/captures\", \"method\": \"POST\" } ], \"reversal\": [ { \"href\": \"https=>\\/\\/sandbox.api.visa.com\\/cybersource\\/payments\\/v1\\/authorizations\\/1785393811423\\/reversals\", \"method\": \"POST\" } ] } }"
```
