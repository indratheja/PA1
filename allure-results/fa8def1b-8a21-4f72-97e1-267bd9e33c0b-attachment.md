...
- Name: alllocators.spec.js >> TC11: Verify TypeScript link is visible and clickable on new page
- Location: tests\alllocators.spec.js:79:5
...
Call log:
  - Expect "toHaveTitle" with timeout 30000ms
    61 × unexpected value "Automation Testing Practice"
...
- table:
  ...
  - rowgroup:
    - row "Chrome 9.1% 60.7 MB 2.9 Mbps 0.77 MB/s":
      - cell "Chrome"
      - cell "9.1%"
      - cell "60.7 MB"
      - cell "2.9 Mbps"
      - cell "0.77 MB/s"
    - row "System 9.7% 43.9 MB 8.7 Mbps 0.88 MB/s":
      - cell "System"
      - cell "9.7%"
      - cell "43.9 MB"
      - cell "8.7 Mbps"
      - cell "0.88 MB/s"
    - row "Firefox 7.7% 94.5 MB 3.4 Mbps 0.45 MB/s":
      - cell "Firefox"
      - cell "7.7%"
      - cell "94.5 MB"
      - cell "3.4 Mbps"
      - cell "0.45 MB/s"
    - row "Internet Explorer 7.3% 78.0 MB 1.9 Mbps 0.68 MB/s":
